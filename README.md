...
```
```
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh)
```
...
```
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh) <domain> [netstack] [port] [username] [password]
```
其中
...
例如
```
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh) abc.mydomain.com
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh) abc.mydomain.com 6
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh) abc.mydomain.com 6 14443
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh) abc.mydomain.com 6 14443 username
bash <(curl -L https://github.com/ponyspeed/installnaive/raw/main/install.sh) abc.mydomain.com 6 14443 username password
```
